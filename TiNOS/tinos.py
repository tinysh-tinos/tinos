        ...
        try:
            for m in get_monitors():
                if m.width == 1920 and m.height == 1080:
                    ...
                    self.text_x = 1400
                    self.text_y = 950
                elif m.width == 1366 and m.height == 768:
                    self.close_x = 1250
                    self.pusk_y = 708
                    self.text_x = 970
                    self.text_y = 650
                elif m.width == 1600 and m.height == 900:
                    self.close_x = 1200
                    self.pusk_y = 840
                    self.text_x = 900
                    self.text_y = 780
                elif m.width == 1280 and m.height == 720:
                    self.close_x = 900
                    self.pusk_y = 660
                    self.text_x = 600
                    self.text_y = 600
                elif m.width == 1024 and m.height == 768:
                    self.close_x = 700
                    self.pusk_y = 708
                    self.text_x = 500
                    self.text_y = 650
                elif m.width == 2560 and m.height == 1440:
                    self.close_x = 2300
                    self.pusk_y = 1380
                    self.text_x = 1800
                    self.text_y = 1280
                elif m.width == 3840 and m.height == 2160:
                    self.close_x = 3600
                    self.pusk_y = 2100
                    self.text_x = 3000
                    self.text_y = 1950
                elif m.width == 1680 and m.height == 1050:
                    self.close_x = 1400
                    self.pusk_y = 990
                    self.text_x = 1100
                    self.text_y = 900
                elif m.width == 1440 and m.height == 900:
                    self.close_x = 100
                    self.pusk_y = 840
                    self.text_x = 800
                    self.text_y = 780
                elif m.width == 800 and m.height == 600:
                    self.close_x = 600
                    self.pusk_y = 540
                    self.text_x = 400
                    self.text_y = 480
                else:
                    self.close_x = m.width - 60
                    self.pusk_y = m.height - 60
                    self.text_x = m.width - 300
                    self.text_y = m.height - 150
        except:
            pass

# Создаем экземпляр менеджера разрешений
res_manager = ResolutionManager()
close = res_manager.close_x
pusk = res_manager.pusk_y
text_x = res_manager.text_x
text_y = res_manager.text_y

def dismiss(window_to_close):
...
# Импортируем filedialog для текстового редактора
